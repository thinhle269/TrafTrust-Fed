...
if __name__ == "__main__":
    ...
    train_federated(args.data_file, args.coords_file, "results",
                    method="fedprox", K=args.clients, R=args.rounds, E=args.local_epochs, B=args.batch_size,
                    lr=args.lr, input_steps=args.input_steps, mu=args.mu_prox, engine=args.engine)
